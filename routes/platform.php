...
use App\Orchid\Screens\ProductVariantEditScreen;
use App\Orchid\Screens\ProductVariantListScreen;
...
Route::screen('product_variant/{product_variant?}', ProductVariantEditScreen::class)
    ->name('platform.product-variant.edit');
